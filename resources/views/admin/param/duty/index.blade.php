        ...
        <div class="row bg-light">
          <div class="panel mx-auto">
            ...
            <div class="panel-body">
              ...
              {!! Form::open(['method' => 'POST', 'action' => 'AdminDutiesController@store']) !!}
      ...
      <div class="col-6">
          <div>
            <table class="table table-striped table-hover table-sm table-bordered"  id="people-table">
              ...
              @foreach($duties as $duty)
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                    {!! Form::open(['method' => 'DELETE', 'action' => ['AdminDutiesController@destroy', $duty->id]]) !!}        
            ...
            <div class="text-center text-sm-right">
				{{ $duties->render("pagination::bootstrap-4") }}
            </div>
          </div>
        <!-- </div> -->
      </div>
