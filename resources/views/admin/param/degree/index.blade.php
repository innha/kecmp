        ...
        <div class="row bg-light">
          <div class="panel mx-auto">
            ...
            <div class="panel-body">
              ...
              {!! Form::open(['method' => 'POST', 'action' => 'AdminDegreesController@store']) !!}
      ...
      <div class="col-6">
          <div>
            <table class="table table-striped table-hover table-sm table-bordered sortable"  id="people-table">
              ...
              @foreach($degrees as $degree)
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                    {!! Form::open(['method' => 'DELETE', 'action' => ['AdminDegreesController@destroy', $degree->id]]) !!}        
            ...
            <div class="text-center text-sm-right">
				{{ $degrees->render("pagination::bootstrap-4") }}
            </div>
          </div>
        <!-- </div> -->
      </div>
