    		...
    		<div id="collapse-personal" class="panel-collapse details collapse in">
      			<div class="panel-body personal-inside p-3">
					...
					<div class="form-group{{$errors->has('lastName') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-8">
						{!! Form::text('lastName', 'Ha', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('firstName') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-8">
						{!! Form::text('firstName', 'Inn', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('fLastName') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-8">
						{!! Form::text('fLastName', 'Hi', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('fFirstName') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-8">
						{!! Form::text('fFirstName', 'En', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('mLastName') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-8">
						{!! Form::text('mLastName', 'Uw', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('mFirstName') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-8">
						{!! Form::text('mFirstName', 'JdA', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('dob') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::date('dob', '1998-02-02', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('birthPlace') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::text('birthPlace', 'Kigali', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('gender') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('gender', ['' => 'Choose gender', 'Male' => 'Male', 'Female' => 'Female'], 'Male', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('idNumber') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::text('idNumber', '112223333333334444', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('maritalStatus') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('maritalStatus', array('' => 'Choose marital status', 'Married' => 'Married', 'Single' => 'Single', 'Divorced' => 'Divorced', 'Widow' => 'Widow'), 'Married', ['class' => 'form-control']) !!}
    		...
    		<div id="collapse-address" class="panel-collapse details collapse in">
      			<div class="panel-body address-inside p-3">
					<div class="form-group{{$errors->has('phoneOne') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::text('phoneOne', '0777777777777', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('phoneTwo') ? ' has-error' : '' }} row">
						...
						<div class="col-sm-9">
						{!! Form::text('phoneTwo', '073333333333', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('email') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::text('email', 'en1@example.com', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('province_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('province_id', array('' => 'Choose province') + $provinces, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('district_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-9">
						{!! Form::select('district_id', array('' => 'Choose district') + $districts, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('sector_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-9">
						{!! Form::select('sector_id', array('' => 'Choose sector') + $sectors, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('cell_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-md-9">
						{!! Form::select('cell_id', array('' => 'Choose cell') + $cells, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('village_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('village_id', array('' => 'Choose village') + $villages, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('diocese_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('diocese_id', array('' => 'Choose diocese') + $dioceses, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('parish_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('parish_id', array('' => 'Choose parish') + $parishes, 1, ['class' => 'form-control']) !!}
						<span class="text-danger">{{ $errors->first('regNumber') }}</span>
						</div>
					</div>
					...
					<div class="form-group{{$errors->has('chapelle_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('chapelle_id', array('' => 'Choose chapelle') + $chapelles, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('zone_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('zone_id', array('' => 'Choose zone') + $zones, 1, ['class' => 'form-control']) !!}
						<span class="text-danger">{{ $errors->first('regNumber') }}</span>
						</div>
					</div>
      			</div>
		...
		<div class="panel panel-default professional-panel card" id="panel-professional">
    		...
    		<div id="collapse-professional" class="panel-collapse details collapse in">
				...
				<div class="form-group{{$errors->has('degree_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('degree_id', array('' => 'Choose education') + $degrees, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('job_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('job_id', array('' => 'Choose job') + $jobs, 1, ['class' => 'form-control']) !!}
    		...
    		<div id="collapse-church" class="panel-collapse details collapse in">
      			<div class="panel-body church-inside p-3">					
      				<div class="form-group{{$errors->has('status_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('status_id', array('' => 'Choose status') + $statuses, 1, ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('baptismDate') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::date('baptismDate', '2000-01-05', ['class' => 'form-control']) !!}
					...
					<div class="form-group{{$errors->has('category_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('category_id[]', array('' => 'Choose category (Press Control to select multiple)') + $categories, 1, ['class' => 'form-control', 'multiple' => 'multiple']) !!}
					...
					<div class="form-group{{$errors->has('task_id') ? ' has-error' : '' }} row">			
						...
						<div class="col-sm-9">
						{!! Form::select('task_id[]', array('' => 'Choose task (Press Control to select multiple)') + $tasks, 1, ['class' => 'form-control', 'multiple' => 'multiple']) !!}
					...
					<div class="form-group{{$errors->has('commission_id') ? ' has-error' : '' }} row">
						...
						<div class="col-sm-9">
						{!! Form::select('commission_id[]', array('' => 'Choose commission (Press Control to select multiple)') + $commissions, 1, ['class' => 'form-control', 'multiple' => 'multiple']) !!}
